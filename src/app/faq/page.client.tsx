...
import HeadingMF from '@/app/components/HeadingMF';
import Nav from '@/app/components/Nav';
import { questionsEN, titleEN } from '@/app/faq/constants/faq.en';
import { questionsZH, titleZH } from '@/app/faq/constants/faq.zh';
...
const FAQPageClient: NextPage = () => {
  const lang = useSearchParams().get('lang') === 'zh' ? 'zh' : 'en';
